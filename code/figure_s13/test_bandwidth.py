...
eval_pts = np.arange(
    0.64, 1.01, 0.04
)  #  percentage of way through pre-transition time series - 10 equally spaced points 60-100% of the way through
...
bw_vals = [2, 5, 10, 20, 40]  # Gaussian band width (# beats)
...
for bw in bw_vals:
    print("Using a bandwidth of {}".format(bw))
