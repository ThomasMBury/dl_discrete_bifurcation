...
Test DL classifier on Kot model with transcritical bifrcation

Single pipeline to:
    - run simulations of Kot model - sweep over different noise and rof values
