...
df_ktau_forced = pd.read_csv('output/df_ktau_pd_fixed_pert_{}.csv'.format(pert))
df_ktau_null = pd.read_csv('output/df_ktau_null_fixed_pert_{}.csv'.format(pert))
df_dl_forced = pd.read_csv('output/df_dl_pd_fixed_pert_{}.csv'.format(pert))
df_dl_null = pd.read_csv('output/df_dl_null_fixed_pert_{}.csv'.format(pert))
...
filepath = 'output/df_fav_bif_pert_{}.csv'.format(pert)
...
# Export ROC data
filepath = 'output/df_roc_pert_{}.csv'.format(pert)
