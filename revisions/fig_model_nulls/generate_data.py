...
Generate data for fig SXX - EWS in a sample of NULL model simulations
...
import sys
sys.path.append(path_prefix+'/test_fox')
sys.path.append(path_prefix+'/test_westerhoff')
sys.path.append(path_prefix+'/test_ricker')
sys.path.append(path_prefix+'/test_kot')
sys.path.append(path_prefix+'/test_lorenz')
...
# Compute EWS
ts_pd = ewstools.TimeSeries(s_null, transition=transition)
...
# Compute EWS
ts_ns = ewstools.TimeSeries(s_null, transition=transition)
...
# Compute EWS
ts_fold = ewstools.TimeSeries(s_null, transition=transition)
...
# Compute EWS
ts_tc = ewstools.TimeSeries(s_null, transition=transition)
...
# Compute EWS
ts_pf = ewstools.TimeSeries(s_null, transition=transition)
